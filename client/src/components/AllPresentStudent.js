...
class AllPresentStudent extends Component {
  ...
  componentDidMount() {
    ...
    fetch('http://' + ip.address + ':3001/mbbspresent')
      .then(res => res.json())
    ...
    render() {
      ...
      const filteredData = studentDate.filter(item => {
        ...
        return (
          ...
          <br />
            <h4>Current FCPS-II Trainees <small className="text-primary">All present FCPS-II records.</small></h4>
            ...
            <div class="alert alert-primary" role="alert">
              All FCPS-II Current Trainees Record.
            </div>
...
export default AllPresentStudent;